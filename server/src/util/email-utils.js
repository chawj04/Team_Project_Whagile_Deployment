    ...
    const info = transporter.sendMail(
      {
        ...
        html: `<h1>안녕하세요 ${memberInfo.name} 님!</h1><br/>
      ...
      <br/>
      <a href="http://whagile.kro.kr:8888/api/account/emailauth?id=${memberInfo.memberCode}&token=${token}">인증 완료</a><br/>
      <br/>
      <br/>
      Whagile Team 올림
      `,
    ...
    const info = transporter.sendMail(
      {
        ...
        html: `<h1>안녕하세요 ${memberInfo.memberName} 님!</h1><br/>
